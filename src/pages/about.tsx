      ...
      <div className={`h-screen bg-gray-200 flex flex-col ${darkMode ? 'dark' : 'light'}`}>
        ...
        <div className="flex-1 overflow-y-auto p-4 pt-[4.5rem] pb-[4.5rem] dark:bg-gray-800 bg-gray-100 ">
          <div className="max-w-screen-lg mx-auto">
            <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100 mt-5">Acerca de Nosotros</h1>
            <div className="container mx-auto px-4 py-8 text-justify">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className='items-center justify-center'>
                  <div className="p-5 flex flex-col items-center justify-center text-center bg-laguna-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="mb-4">
                    El sitio web fue puesto en marcha por <a href="https://www.linkedin.com/in/guillermo-rohde-b240b416/" target='_blank'>Guillermo</a>, quien se aseguró de que todo funcione bien en nuestros servidores.
                    El desarrollo del sitio fue realizado por <a href="https://www.linkedin.com/in/facundouferer/" target='_blank'>Facundo</a>, quien trabajó duro para hacer que este sitio sea fácil de usar.
                    El diseño de ésta aplicaicón está basado en los diseños realizados por <a href="https://www.linkedin.com/in/jackiegerber/" target='_blank'>Jacqueline</a>.
                    <br />
